...
with open('results_paper/results_TTR=5.json', 'r') as json_file:
...
count_0 = len([value for value in ttf_values  if value < 5])
count_1 = len([value for value in ttf_values  if value < 2])
count_2 = len([value for value in ttf_values  if value < 0.5])
count_3 = len([value for value in ttf_values  if value < 0.2])
count_4 = len([value for value in ttf_values  if value < 0.1])
count_5 = len([value for value in ttf_values if value < 0.1])
count_6 = len([value for value in ttf_values  if value < 0.1])
count_7 = len([value for value in ttf_values  if value < 0.1])
count_8 = len([value for value in ttf_values  if value < 0.1])
