...
with open('results_paper/results_TTR=15.json', 'r') as json_file:
...
count_0 = len([value for value in ttf_values if value < 20])
...
count_5 = len([value for value in ttf_values if value < 0.2])
