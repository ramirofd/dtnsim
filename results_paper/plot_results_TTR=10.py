...
with open('results_paper/results_TTR=10.json', 'r') as json_file:
...
count_0 = len([value for value in ttf_values if value < 10])
count_1 = len([value for value in ttf_values if value < 5])
count_2 = len([value for value in ttf_values if value < 1])
count_3 = len([value for value in ttf_values if value < 0.5])
count_4 = len([value for value in ttf_values if value < 0.2])
