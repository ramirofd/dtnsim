...
contacts_to_remove_3 = ('LEO_ran000_tan016', 'GST_lat025_lon055')

GST_to_keep = ['GST_lat-31_lon-64', 'GST_lat-46_lon168', 'GST_lat025_lon055']
HAPS_to_keep = ['HAP_lat-31_lon-64', 'HAP_lat-46_lon168', 'HAP_lat025_lon055']
...
output_file = 'contactPlan/contact_plan_7d_node-ids_1LEO_3HAP_3GST.txt'
...
for line in lines:
    ...
    if(columns[4] == name_to_id[contacts_to_remove_2[1]] and columns[5] == name_to_id[contacts_to_remove_2[0]]):
        continue
    if(columns[4] == name_to_id[contacts_to_remove_3[0]] and columns[5] == name_to_id[contacts_to_remove_3[1]]):
        continue
    if(columns[4] == name_to_id[contacts_to_remove_3[1]] and columns[5] == name_to_id[contacts_to_remove_3[0]]):
        continue
