...
count_0 = len([value for value in ttf_values if value < 25])
...
count_6 = len([value for value in ttf_values if value < 0.2])
count_7 = len([value for value in ttf_values if value < 0.2])
count_8 = len([value for value in ttf_values if value < 0.2])
