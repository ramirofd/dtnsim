...
count_0 = len([value for value in results1[scenarios[0]][0] if value < 25])
...
count_3 = len([value for value in results1[scenarios[3]][0] if value < 1])
count_4 = len([value for value in results1[scenarios[4]][0] if value < 0.5])
count_5 = len([value for value in results1[scenarios[5]][0] if value < 0.5])
count_6 = len([value for value in results1[scenarios[6]][0] if value < 0.2])
count_7 = len([value for value in results1[scenarios[7]][0] if value < 0.2])
count_8 = len([value for value in results1[scenarios[8]][0] if value < 0.2])
...
with open('results_paper/results_TTR=20.json', 'w') as json_file:
