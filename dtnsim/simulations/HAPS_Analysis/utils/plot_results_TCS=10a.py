...
count_0 = len([value for value in results1[scenarios[0]][0] if value < 10])
count_1 = len([value for value in results1[scenarios[1]][0] if value < 5])
count_2 = len([value for value in results1[scenarios[2]][0] if value < 1])
count_3 = len([value for value in results1[scenarios[3]][0] if value < 0.5])
count_4 = len([value for value in results1[scenarios[4]][0] if value < 0.2])
...
with open('results_paper/results_TTR=10.json', 'w') as json_file:
