...
count_0 = len([value for value in results1[scenarios[0]][0] if value < 5])
count_1 = len([value for value in results1[scenarios[1]][0] if value < 2])
count_2 = len([value for value in results1[scenarios[2]][0] if value < 0.5])
count_3 = len([value for value in results1[scenarios[3]][0] if value < 0.2])
count_4 = len([value for value in results1[scenarios[4]][0] if value < 0.1])
count_5 = len([value for value in results1[scenarios[5]][0] if value < 0.1])
...
with open('results_paper/results_TTR=5.json', 'w') as json_file:
