...
count_0 = len([value for value in results1[scenarios[0]][0] if value < 30])
...
count_6 = len([value for value in results1[scenarios[6]][0] if value < 0.5])
count_7 = len([value for value in results1[scenarios[7]][0] if value < 0.5])
count_8 = len([value for value in results1[scenarios[8]][0] if value < 0.5])
...
with open('results_paper/results_TTR=25.json', 'w') as json_file:
